...
for i in range(7):
  ...
  print("] = {", end = "")
  for u in children[i]:
    print(u, container_def[u].name, end = ", ")
  print("}")
# assumed that the 0th element is GlobalConfig
...
# final_out("containers_testing.xml", AS)

# I assume that the 0th element is GlobalConfig
containers_bfs = [container() for _ in range(max_nodes)] 
bfs = [0]
